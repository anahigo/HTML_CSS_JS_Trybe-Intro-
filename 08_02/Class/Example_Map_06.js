...
for(let i = 0; i < estudantes.length; i += 1 ){
  if(estudantes[i].turno === 'Manhã'){
    allNameStudentsFor.push(`${estudantes[i].nome} ${estudantes[i].sobrenome}`)
  }
}
...
const reportStatusFor = (name, students) => {
  let getStudent;
...
console.log(reportStatusFor('Natalia', estudantes))
/*
[
  'Matemática Aprovado',
  'Português Aprovado',
...
//  find e map:
const reportStatusMap = (name, students) => {
...
console.log(reportStatusMap('Natalia', estudantes));
/*
[
  'Matemática Aprovado',
  'Português Aprovado',
